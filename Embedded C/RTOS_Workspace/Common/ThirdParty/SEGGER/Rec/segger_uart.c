...
#define OS_FSYS 			      170000000L   // MCU core frequency of Flasher ARM Pro V4
#define RCC_BASE_ADDR       0x40021000

#define OFF_AHB1ENR         0x48        // AHB1 peripheral clock enable register
#define OFF_AHB2ENR			    0x4C		    // AHB2 peripheral clock enable register
...
#define OFF_RDR             0x24        // Received Data register
#define OFF_TDR				      0x28		    // Transmitted Data Register
...
#define UART_BASECLK        OS_FSYS / 1       // USART2 runs on APB1 clock
