...
TEST(account_test_group, good_deposit)
{
	...
	accountRetCode ret = testAccount.deposit(1000);
...
{
	Account testAccount("Test Account",2000);
	accountRetCode ret = testAccount.deposit(-500);
	float Balance = testAccount.getBalance();
...
{
	Account testAccount("Test Account",2000);
	accountRetCode ret = testAccount.withdraw(1000);
	float Balance = testAccount.getBalance();
...
{
	Account testAccount("Test Account",2000);
	accountRetCode ret = testAccount.withdraw(3000);
	float Balance = testAccount.getBalance();
...
{
	Account testAccount("Test Account",2000);
	accountRetCode ret = testAccount.withdraw(-500);
	float Balance = testAccount.getBalance();
...
TEST(account_test_group, equal_Accounts)
{
	...
	accountRetCode ret = (testAccount1 == testAccount2);
